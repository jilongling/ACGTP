...
METHODS: Dict[str, List[str]] = {
    ...
    "functional_quota_static_050": BASE_INTERNAL + [
        "--acgtp_internal_functional_quota_enabled", "true",
    ],
    "functional_no_layout_050": BASE_INTERNAL + [
        "--acgtp_internal_functional_quota_enabled", "true",
        "--acgtp_internal_layout_quota_ratio", "0.0",
    ],
    "functional_no_contact_050": BASE_INTERNAL + [
        "--acgtp_internal_functional_quota_enabled", "true",
        "--acgtp_internal_contact_quota_ratio", "0.0",
    ],
    "functional_no_motion_050": BASE_INTERNAL + [
        "--acgtp_internal_functional_quota_enabled", "true",
        "--acgtp_internal_motion_quota_ratio", "0.0",
    ],
    "functional_no_semantic_050": BASE_INTERNAL + [
        "--acgtp_internal_functional_quota_enabled", "true",
        "--acgtp_internal_semantic_quota_ratio", "0.0",
    ],
    "functional_no_fill_050": BASE_INTERNAL + [
        "--acgtp_internal_functional_quota_enabled", "true",
        "--acgtp_internal_fill_quota_ratio", "0.0",
    ],
    "legacy_geo_guarded_quota_050": BASE_INTERNAL + [
